...
type DeliverTokenReq struct {
	...
	UserRole string `protobuf:"bytes,2,opt,name=user_role,json=userRole,proto3" json:"user_role,omitempty"` // 用户角色（如 admin、user）
	Resource string `protobuf:"bytes,3,opt,name=resource,proto3" json:"resource,omitempty"`                 // 资源路径（如 /data）
	Action   string `protobuf:"bytes,4,opt,name=action,proto3" json:"action,omitempty"`                     // 操作类型（如 GET、POST）
}
...
var file_auth_proto_rawDesc = []byte{
	...
	0x2e, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x35, 0x5a,
	0x33, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x78, 0x76, 0x78, 0x69,
	0x61, 0x6f, 0x6d, 0x61, 0x6e, 0x38, 0x2f, 0x67, 0x6f, 0x6d, 0x61, 0x6c, 0x6c, 0x2f, 0x72, 0x70,
